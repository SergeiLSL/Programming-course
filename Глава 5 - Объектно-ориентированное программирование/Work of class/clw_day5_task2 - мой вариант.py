...
print('\n')
sqr = Square(5)
sqr.print_sides('Стороны квадрата')  # Стороны квадрата : [5, 5, 5, 5]
sqr.print_per('квадрат')  # Периметр квадрат = 20
sqr.print_sqr()  # Площадь квадрата = 25
...
try:
    ...
    print('ERROR', e)  # ERROR Ошибка при инициализации треугольника!
    # Со сторонами такой длины сторон построить треугольник невозможно!

trgl2 = Triangle(5, 2, 4)
trgl2.print_sides('Стороны треугольника')  # Стороны треугольника : [2, 4, 5]
trgl2.print_per('треугольника')  # Периметр треугольника = 11
trgl2.print_sqr()  # Площадь треугольника = 3.799671038392666
...
try:
    ...
    print('ERROR', e)  # ERROR Ошибка при инициализации четырехугольника!
    # Со сторонами такой длины сторон построить четырехугольник невозможно!

plgn2 = Polygon(5, 2, 4, 3)
plgn2.print_sides('Стороны четырехугольника')  # Стороны четырехугольника : [2, 3, 4, 5]
plgn2.print_per('четырехугольника')  # Периметр четырехугольник = 14
plgn2.print_sqr()  # Рассчитать площадь произвольного
# четырехугольника без знания 2 углов невозможно
